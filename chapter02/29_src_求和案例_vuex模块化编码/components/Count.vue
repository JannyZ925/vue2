...
export default {
  ...
  computed: {
    ...
    ...mapState('count', {sum: 'sum', school: 'school', subject: 'subject'}),
  ...
  methods: {
    ...
    ...mapMutations('count', {add: 'ADD', sub: 'SUB'}),

    // 借助mapActions生成对应方法，方法中会调用dispatch联系actions(对象写法)
    ...mapActions('count', {addWhenSumIsOdd: 'addWhenSumIsOdd', addForAMoment: 'addForAMoment'}),
  }
}
</script>
